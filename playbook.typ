#import "playbook_data_blessed.typ": playbook
...
#let make_playbook(
  ...
  backgrounds: playbook.backgrounds,
  instincts: playbook.instincts,
  appearances: playbook.appearances,
  origins_and_names: playbook.origins_and_names,
  default_special_possessions: playbook.default_special_possessions,
  special_possessions: playbook.special_possessions,
  moves: playbook.moves,
  character_question_sections: playbook.character_question_sections,
  introductions: playbook.introductions) = {
  let page1 = [
    /* Headers */
    #grid(
      columns: (6.2fr, 1fr),
